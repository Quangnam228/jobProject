...
export default function NewUserAdmin() {
  ...
  const handleClick = (e) => {
    ...
    if (user?.password === '' || user?.email === '' || user?.username === '' || user?.confirmPassword === '') {
      ...
      <div className="newUserContainer">
        ...
        <form className="newUserForm">
          <div className="newUserItem">
            ...
            <input name="username" value={username} type="text" placeholder="john" onChange={handleChangeUsername} />
          </div>

          <div className="newUserItem">
            <label>Email</label>
            <input name="email" value={email} type="email" placeholder="john@gmail.com" onChange={handleChangeEmail} />
          </div>
          <div className="newUserItem">
